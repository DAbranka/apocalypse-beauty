...
<template>
    <div
        ...
        class="relative my-20 flex flex-row text-black justify-center items-center text-center font-aclonica"
    >
        <img
        ...
        <div
            ...
            class="absolute mt-80 ml-80 w-60 h-32 text-center flex flex-col justify-center rounded-2xl bg-pink-600"
        >
            ...
            >
                <a href="#"
                    ><span class="bg-black py-2 px-5 rounded-xl">Show</span></a
                >
            </div>
        </div>
    </div>
